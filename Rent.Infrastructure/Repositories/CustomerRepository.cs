...
namespace Rent.Infrastructure.Repositories
{
    public class CustomerRepository : BaseRepository, ICustomerRepository
    {
        ...
        public async Task<(List<Customer>, PaginationMeta)> GetAllCustomers(int pageNumber, int pageSize)
        {
        ...
        {
            var query = await _context.Customers.FindAsync(customer.Id) ?? throw new Exception("Customer not found.");
        ...
        {
            var query = await _context.Customers.FindAsync(id) ?? throw new Exception("Customer not found.");
